...
ChatSpatial exposes **21 schema-validated MCP tools** that orchestrate **67 spatial transcriptomics methods** across **15 analytical categories**. The tools are the stable natural-language interface; the methods are the analysis backends selected through tool parameters.
...
Current coverage includes 67 methods across 15 analytical categories, exposed through 21 MCP tools. Supports 10x Visium, Xenium, Slide-seq v2, MERFISH, seqFISH.

| Category | Example methods |
|----------|---------|
| **Data Loading & Preprocessing** | Scanpy I/O, DeepSpot-M virtual spatial transcriptomics, QC, Normalization, HVG, PCA, Neighbors |
