...
class SpatialStatisticsIntegrationResult(BaseModel):
    ...
    methods_used: List[str]  # e.g., ['local_moran', 'getis_ord', 'neighborhood_enrichment']
    ...
    visualization_features: Optional[Dict[str, List[str]]] = None  # Available features for visualization
...
class SpatialVisualizationData(BaseModel):
    ...
    local_moran_features: Optional[Dict[str, Dict[str, Any]]] = None  # Gene -> feature data
    getis_ord_features: Optional[Dict[str, Dict[str, Any]]] = None  # Gene -> feature data
    bivariate_moran_features: Optional[Dict[str, Dict[str, Any]]] = None  # Pair -> feature data
...
class SpatialAnalysisSummary(BaseModel):
    ...
    interpretation_guide: Optional[Dict[str, str]] = None  # Method -> interpretation text
