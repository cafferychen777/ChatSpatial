...
from .image_utils import get_cached_figure, load_figure_pickle  # noqa: E402
...
async def export_for_publication(
    ...
    if context:
        ...
        await context.info(f"Exporting {plot_type} as {format_info} for publication...")
...
async def batch_export_for_publication(
    ...
    if context:
        ...
        await context.info(f"✅ Batch export complete: {total_exported} files exported")
