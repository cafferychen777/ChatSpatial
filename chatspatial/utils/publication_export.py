...
def get_publication_presets(journal: str = "nature") -> Dict[str, Any]:
    """Get publication presets for specific journals
    
    Args:
        journal: Journal name ('nature', 'science', 'cell', 'pnas', etc.)
        
    Returns:
        Dictionary of recommended settings for the journal
    """
    presets = {
        "nature": {
            "format": "pdf",
            "dpi": 300,
            "figure_width": 8.9,  # cm, single column
            "figure_height": 24.7,  # cm, max
            "font_size": 8,
            "font_family": "Arial",
            "line_width": 0.5
        },
        "science": {
            "format": "pdf", 
            "dpi": 300,
            "figure_width": 8.4,  # cm, single column
            "figure_height": 23.5,  # cm, max
            "font_size": 8,
        ...
        "cell": {
            "format": "pdf",
            "dpi": 300,
            "figure_width": 8.5,  # cm, single column
            "figure_height": 24,  # cm, max
            "font_size": 8,
            "font_family": "Arial",
            "line_width": 0.5
        },
        "pnas": {
            "format": "pdf",
            "dpi": 600,  # PNAS requires higher DPI
            "figure_width": 8.7,  # cm, single column
            "figure_height": 23.5,  # cm, max
            "font_size": 9,
            "font_family": "Arial",
            "line_width": 0.5
    ...
    return presets.get(journal.lower(), presets["nature"])