...
def _validate_spatial_data_internal(
    adata: "sc.AnnData", spatial_key: str, issues: List[str]
) -> None:
    ...
    if spatial_coords.shape[1] < 2:
        issues.append(
            f"Spatial coordinates should have at least 2 dimensions, found {spatial_coords.shape[1]}"
        )
