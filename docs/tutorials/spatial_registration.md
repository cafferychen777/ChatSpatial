...
This tutorial shows you how to register and align multiple spatial transcriptomics slices using **natural language** in Claude Desktop. Whether you're aligning adjacent tissue sections or analyzing time series data, ChatSpatial makes spatial alignment intuitive and accessible.
...
## Part 1: Understanding Spatial Registration
...
**🤖 Claude:** "Absolutely! Spatial registration is perfect for comparing brain sections. I can help you align your mouse brain sections using PASTE (Probabilistic Alignment of Spatial Transcriptomics Experiments), which is excellent for brain tissue.
...
**🤖 Claude:** "Perfect! Let me load all three brain sections and check their compatibility for registration."

*[ChatSpatial loads all three datasets]*

**🤖 Claude:** "Excellent! I've loaded your three brain sections:
...
**🤖 Claude:** "I'll register your brain sections using PASTE with optimized parameters for brain tissue. This will align the sections in a common coordinate system for comparative analysis."
...
**🤖 Claude:** "Excellent! You can see how the three brain sections align perfectly:
...
The alignment preserved the anatomical continuity - you can compare structures like the hippocampus and cortical columns across all three sections. The tissue architecture correspondence is beautifully maintained!"
...
- ✅ **Optimal transport theory** finds best correspondences
...
**🤖 Claude:** "Great observation! The hippocampus has complex curved geometry that can be challenging to align. Let me optimize the PASTE parameters specifically for better hippocampal preservation."
...
**🤖 Claude:** "Much better! The optimized registration shows:
...
The hippocampus now shows beautiful continuity across all three sections, with preserved curved architecture. The CA fields and dentate gyrus align perfectly!"
...
**🤖 Claude:** "Excellent question! Let me compute comprehensive quality metrics for your brain registration that you can include in your publication."
...
For your publication, report: 'Spatial registration achieved high quality alignment (spatial coherence: 0.91 ± 0.04, gene correlation: 0.93 ± 0.02) with excellent preservation of anatomical structures (96% landmark alignment)'."
...
**🤖 Claude:** "Absolutely! I'll create a detailed 2D visualization that highlights the spatial organization of different cell types across your registered brain sections."
...
The registration perfectly preserved the hippocampal laminar organization across all three sections!"
...
**🤖 Claude:** "Perfect application for temporal spatial registration! Wound healing involves dramatic tissue reorganization, so I'll use specialized parameters to track these dynamic changes.
...
**🤖 Claude:** "Fascinating results! The temporal registration reveals:
...
**🤖 Claude:** "Excellent idea! STalign (Spatial Transcriptomics Alignment) can leverage both your expression data and histology images for more accurate registration. This is particularly powerful for complex tissue architectures.
...
**Current Status:** PASTE provides excellent results for your brain sections. STalign will offer additional precision when image data is critical for alignment.
...
- ✅ **Well-validated** algorithm with extensive use
...
- **Solution:** I'll identify common genes and subset your data
...
**🤖 Claude:** "Found and fixed the issues!
...
Spatial registration in ChatSpatial provides powerful capabilities for:
...
The conversational interface makes complex spatial registration accessible to biologists, while maintaining the rigor required for scientific publication. Just describe what you want to achieve, and ChatSpatial handles the technical complexity!

---

## Next Steps

- **Advanced Analysis:** [Cell Communication Analysis](cell_communication_analysis.md)
- **2D Visualization:** [Visualization Tutorial](visualization_tutorial.md)  
- **Getting Started:** [Basic Spatial Analysis](basic_spatial_analysis.md)

Remember: ChatSpatial makes spatial registration as simple as having a conversation with an expert colleague who happens to know all the technical details!