...
client examples, HTTP mode, local builds, and troubleshooting stay in one place.

Key rules:

- Use a versioned image such as `ghcr.io/cafferychen777/chatspatial:v1.3.5` for reproducible analyses.
...
- Use Streamable HTTP rather than the deprecated SSE transport for HTTP deployments.
